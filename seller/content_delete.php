...
<head>
    ...
    <meta http-equiv="refresh" content="3;URL='content_all.php'" />  
...
//$sql = "UPDATE  `$DBSOFTX`.`howto` SET  `title_howto` =  '$title', `des_howto` =  '$des', `keyword_howto` =  '$key', `heading_howto` =  '$h1', `content_howto` =  '$content' WHERE  `howto`.`id_howto` =1 LIMIT 1 ;";
$sql = "DELETE FROM `content` WHERE `content`.`id_content` = $_id LIMIT 1;";
$on = $conn->query($sql);
if(!$on){
echo 'Error!';
}
