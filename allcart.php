...
<!-- <option value="50">รับทาง </option> -->
<!-- <option value="50">จัดส่งภายในพื้นที่ (50.-)</option>
<option value="50">จัดส่งภายในพื้นที่ (50.-)</option> -->
...
<tr>
<th colspan="5">
<a href="#" class="buy3" onclick="return checksubmit(this);">ยืนยันการสั่งซื้อสินค้า (Checkout) &gt;&gt;</a>
</th>
</tr>
<?php
}else{
