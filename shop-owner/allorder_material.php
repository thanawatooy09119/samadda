...
<p>
<a href="#" class="yes-check" onclick="return false;" >ยืนยัน</a>
...
echo i_result($on,$x,"list_$TBNAME");
echo ' / ';
echo i_result($on,$x,"qty_$TBNAME");
echo '</a></td>';

echo '<td style="font-weight:bold;">'.number_format(i_result($on,$x,"price_$TBNAME")).'</td>';
echo '<td>';
