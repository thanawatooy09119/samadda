...
?>
<form action="contact_update.php" method="post" name="howto" id="howto">
<div id="infomation">
        ชื่อเรื่อง: <input type="text" name="title" id="title" placeholder="your title" value="<?php echo i_result($on,0,"title_howto");?>"
        />
        <br>
        หัวเรื่อง: <input type="text" name="heading" id="heading" placeholder="your heading" value="<?php echo i_result($on,0,"heading_howto");?>">
        <br>
        คำสำคัญ: <input type="text" name="key" id="key" placeholder="keyword1 keyword2,keyword3,keyword4,keyword5" value="<?php echo i_result($on,0,"keyword_howto");?>">    
        <br>    
        คำอธิบาย: <input type="text" name="desc" id="desc" placeholder="your description" value="<?php echo i_result($on,0,"des_howto");?>">
</div>    
