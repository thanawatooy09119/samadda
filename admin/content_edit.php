    ...
    <form action="content_update.php" method="post" name="m2" id="m2">
        ...
        <div>
            <div style="font-size: 16px; font-weight: bold; text-align: center;">
                แก้ไข ข่าวประชาสัมพันธ์
            </div>
        </div><br>
        <div id="infomation">
            ชื่อเรื่อ: <input type="text" name="title" id="title" placeholder="your title"
                value="<?php echo i_result($on,0,"title_content");?>" />
            <br>
            หัวเรื่อง: <input type="text" name="heading" id="heading" placeholder="your heading"
                value="<?php echo i_result($on,0,"heading_content");?>">
            <br>
            คำสำคัญ: <input type="text" name="key" id="key" placeholder="keyword1 keyword2,keyword3,keyword4,keyword5"
                value="<?php echo i_result($on,0,"keyword_content");?>">
            <br>
            คำอธิบาย: <input type="text" name="desc" id="desc" placeholder="your description"
                value="<?php echo i_result($on,0,"des_content");?>">
            <hr />
