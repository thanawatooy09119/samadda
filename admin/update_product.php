...
?>
    ...
    <meta http-equiv="refresh" content="3;URL=edit_product.php?id=171<?=$_id;?>" />  
...
$update_sql = "UPDATE `$DBSOFTX`.`product`  SET  `name_product` =  '".$_name."',`des_product` =  '".$_des."', `type_product` =  '".$_type."', `stock_product` =  '".$_stock."', `dprice_product` =  '".$_dprice."', `price_product` =  '".$_price."', `img1` =  '".$big_img[1]."', `img2` =  '".$big_img[2]."', `img3` =  '".$big_img[3]."', `img4` =  '".$big_img[4]."', `img5` =  '".$big_img[5]."', `status_product` =  '".$_status."' WHERE  `product`.`id_product` = '".$_id."' LIMIT 1 ;";
