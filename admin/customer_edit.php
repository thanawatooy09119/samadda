...
$_status = i_result($on,0,status_customer);
...
?>
    ...
    <form action="customer_update.php" method="post" name="m2" id="m2">
        <table border="0" cellpadding="0" cellspacing="0" id="addproduct">
            <tr>
                ...
                <td>
                    <input type="text" name="myuser" value="<?=i_result($on,0,user_customer);?>" disabled />
            ...
            <tr>
                ...
                <td>
                    <input type="password" name="mypass" value="" placeholder="ไม่เปลี่ยนแปลง (กรุณาเว้นว่างไว้)"
                        style="border:1px #c0c0c0 solid;color:red;" />
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="myname" value="<?=i_result($on,0,name_customer);?>" />
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="mytel" value="<?=i_result($on,0,tel_customer);?>" />
       ...
       <?=i_result($on,0,address_customer);?>
      </textarea>
