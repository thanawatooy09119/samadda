...
<?php
	...
	$rep = str_replace("../../notebook/","",$upload_image);
		echo '<img src="img/success.gif" width="16" height="16" border="0" style="marin-bottom: -4px;" /> Success!<br /><input type="text"  value="'.$rep.'" style="width:220px;margin:2px;border:1px #ececec solid;" />';
		echo '
...
insertNodeOverSelection(x, document.getElementById(\'editor\'));" />
