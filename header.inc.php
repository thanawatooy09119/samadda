...
<div class="Header">
    ...
    <div id="sidr">
        ...
        <div class="inheader">
            ...
            <!-- <img src="images/123456.png" alt="" width="500" height="300"> -->
          ...
          ?>
            ...
            <a href="howto.php" <?php if ($_self == "howto.php") {
                    ...
                    style="font-size:22px"></span>&nbsp;วิธีการสั่งซื้อ</a>
            <span class="no">&nbsp;</span>
...
<div class="loginform">
    <form id="loginform">
        <h5 style="text-align:center;"><span class="imadelogo">สมัดดาผ้าทอมือ</span><span class="ibricklogo"></span>
            (เข้าสู่ระบบ)</h5>
        <div class="ihr"></div>
...
<div class="settingform">
    <form id="settingform">
        ...
        <div class="ihr"></div>
        <input type="text" name="firstname" class="settinguser" placeholder="ชื่อผู้ใช้งาน (username)"
            value="<?= $_SESSION['myuser']; ?>" disabled />
        <br />
        ...
        <div class="ihr"></div>
        <input type="text" name="fullname" class="settingfullname" placeholder="ชื่อ - สกุล"
            value="<?= $_SESSION['myname']; ?>" />
        <input type="text" name="address" class="settingaddress" placeholder="ที่อยู่"
